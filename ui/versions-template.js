(() => {
  ...
  workbench.versionsTemplate = `
    <section id="versions-page" class="page panel versions-panel" aria-label="版本记录" tabindex="-1" hidden>
      <div class="panel-content">
        <div class="version-toolbar">
          <div class="field version-picker"><label for="versions">选择提示词版本 <span class="version-count">共 <span id="version-count">0</span> 个</span></label><select id="versions"><option value="">尚未保存版本</option></select></div>
          <div class="version-actions"><button type="button" id="export" class="button button-secondary">导出工作记录 <span aria-hidden="true">↗</span></button><button type="button" class="button button-secondary" data-open-page="workbench">返回编辑</button><button type="button" class="button button-primary" data-open-page="trial">前往试写 <span aria-hidden="true">→</span></button></div>
        </div>
