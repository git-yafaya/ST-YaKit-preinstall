    ...
    <div id="trial-page" class="page" tabindex="-1" hidden>
      <section id="trial-panel" class="panel trial-panel" aria-labelledby="trial-title">
          ...
          <article id="trial-output" class="trial-output" tabindex="0" aria-label="试写正文，可选中片段作为反馈" hidden></article>
            ...
            <div class="feedback-actions"><button class="text-button" data-open-page="workbench">返回编辑</button><button id="save-feedback" class="button button-secondary">保存反馈</button><button id="revise" class="button button-primary">按反馈修改 <span aria-hidden="true">↗</span></button></div>
