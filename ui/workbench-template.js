  ...
  workbench.workbenchTemplate = `
    <div id="app-shell" class="app-shell">
      ...
      <div id="workbench-page" class="page workbench" tabindex="-1">
        <section id="design-panel" class="panel design-panel" aria-label="需求与修改">
        ...
        <section class="panel draft-panel" aria-label="提示词草稿">
          ...
          <div class="draft-toolbar"><span id="draft-state">当前草稿</span><button type="button" id="copy" class="button button-secondary">复制提示词 <span aria-hidden="true">⧉</span></button></div>
          ...
          <div class="draft-save">
            ...
            <div class="save-row"><label for="version-label" class="sr-only">新版本名称</label><input id="version-label" placeholder="版本名称（选填）" maxlength="80"><button type="button" id="save-version" class="button button-secondary">保存为版本 <span aria-hidden="true">＋</span></button></div>
    ...
    <div id="busy-bar" class="busy-bar" role="status" hidden><span class="spinner"></span><span id="busy-text">正在生成…</span><button type="button" id="cancel" class="button button-secondary">取消</button></div>
  `;
})();
